...
<!-- TALK: 重要だが時間外の話題を明示する。後半の質疑で関心があれば掘り下げる旨を伝える。
はなさないこと AI活用: FLOSSへAIを利用する是非
-->
...
<!-- _header: '第一部：オープンの力とは何だったのか' -->
<!-- TALK: OSMの概要を簡潔に紹介するスライド。Steve Coast. London, HOT, 
-->
## OpenStreetMap
...
<!-- _header: '第二部：分散型SNS ― オープンの新しい波' -->
<!-- TALK: Scale の限界をこえるために、クライアントと、接続してデータを格納されるPDSサーバと、接続して検索して閲覧するIndexのサーバにわかれている。
また、モデレーション地獄：これは、アメリカ大統領の選挙などのときに、デマや誹謗中傷がたくさんでてきて、クレーム対応が頻発したりして、結局人界戦術で対処している。
言論の自由の立場からは、発言させないというのはよろしくないが、人権保護の立場からはただ流すわけにはいかない。
PDSとINDEXが、別々の組織や個人で実現できる、サービスを選んでくれという思想になっている。
-->
...
INDEXはおもいが、PDSは手頃. UXの改良がはじまっている。MisskeyでUX改良されたMastdonともいえる。 -->
## なぜ成功しているのか？
...
<!-- TALK: オープンはソフトだけでなくハードへ。RISC-Vは技術主権・カスタマイズ・コストの別ニーズで支持拡大。
2030年25%予測を紹介。 -->
## RISC-V：ハードウェアでも
...
**参入障壁**：
- H100 GPUは数百万円, 基盤モデルの学習には数10億円以上
- 個人や小組織は「見る」だけ
